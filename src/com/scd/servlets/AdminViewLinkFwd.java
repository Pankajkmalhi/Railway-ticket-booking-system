		...
		if(ck!=null) {
			...
			if(!uName.equals("")||uName!=null) {
				try {
					...
					PreparedStatement ps = con.prepareStatement("Select * from traindata where tr_no=? and from_stn=? and to_stn=?");
					...
					if(rs.next()) {
						...
						pw.println("<div class='tab'>"
								...
								+ "<tr><td class='blue'>pkr :</td><td>"+rs.getLong("fare")+" RS</td></tr>"
								+ "</table>"
								+ "</div>");
					}
					else {
