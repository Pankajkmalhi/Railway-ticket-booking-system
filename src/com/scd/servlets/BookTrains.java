		...
		if(ck!=null) {
			...
			if(!uName.equals("")||uName != null )
			{
				...
				try {
					...
					PreparedStatement ps = con.prepareStatement("Select * from traindata where tr_no = ?");
					...
					if(rs.next())
					{
						...
						if(seat>avail) {
							...
							avail = avail - seat;
							PreparedStatement ps1 = con.prepareStatement("update traindata set available=? where tr_no=?");
							ps1.setLong(1, avail);
