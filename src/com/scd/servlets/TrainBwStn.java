package com.scd.servlets;
import java.io.*;
import javax.servlet.*;
import javax.servlet.http.*;

import com.scd.utility.DBConnection;
		...
		if(ck!=null) {
			...
			if(!uName.equals("")||uName!=null) {
				try {
					...
					PreparedStatement ps = con.prepareStatement("Select * from traindata where from_stn=? and to_stn=?");
					...
					if(rs.next()) 
					{
						...
						pw.println("<div class='tab'><table><tr><th>Train Name</th><th>Train No</th>"
								+ "<th>From Stn</th><th>To Stn</th><th>Seats</th><th>pkr</th></tr>");
						do {
								pw.println(""
